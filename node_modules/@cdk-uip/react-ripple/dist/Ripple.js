...
var Ripple = function (_React$Component) {
  ...
  _createClass(Ripple, [{
    ...
    value: function componentDidMount() {
      if (this.control) {
        _mdc.MDCRipple.attachTo(this.control);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ["primary", "accent", "className", "children"]);
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          className: (0, _classnames2.default)("mdc-ripple-surface", {
